...
INSERT INTO `recetas` VALUES (1,1,'Primero corta las jud?as verdes y se ponen a hervir durante 20 minutos. Ademas, se cuecen los huevos. Se parte la cebolleta, puedes dejarla en agua para que su sabor pierda fuerza. Se lava el tomate, pimiento y lechuga y se trocea. Se mezcla todo el un plato. Cuando est?n las jud?as y los huevos cocidos se trocean y se a?aden de la misma manera. Se le a?ade atun','Ensalada'),(2,4,'Primero se cuecen los espaguetis alrededor de unos 9 minutos. Se corta la cebolla en pedacitos peque?os y se fr?en durante unos 10 minutos. En un bol, dos huevos. Se echa la nata en con la cebolla y el huevo, se deja durante un par de minutos. Echamos el bacon troceado. Luego lo mezclamos todo con los espaguetis','Espaguetis Carbonara'),(3,1,'Primero se derrite el chocolate en un cazo o en el microondas hasta que quede totalmente l?quido. Luego se trocea y se rallan las avellanas. Se mezcla todo en un molde o algun recipiente. Se introduce en el congelador durante 2 horas aproximadamente','Helado de chocolate y avellanas'),(4,2,'Primero se debe enjuagar la quinoa y ponerla a hervir durante 15 minutos hasta que el agua haya desaparecido. Se va cortando el pepino, tomate y los pimientos en trozos peque?os mientras tanto. Cuando la quinoa est? lista, se mezcla todo en un bol a?adi?ndole atun','Ensalada de quinoa y atun'),(5,1,'Primero se pela una cebolla y se parte, se le quita la piel a la calabaza y se corta de igual manera. En una olla se introduce la cebolla a fuego suave. Cuando esta comience a dorarse, a?adimos agua y se deja cocer durante 20 minutos. Pasado este tiempo, trituramos todo en la batidora y ya estar?a lista la crema de calabaza','Crema de calabaza');
