...
INSERT INTO `ingredientes` VALUES (1,'guisantes'),(2,'salchichón'),(3,'atún'),(4,'orégano'),(5,'setas'),(6,'remolacha'),(7,'sandía'),(8,'salmón'),(9,'cebolleta'),(10,'langosta'),(11,'coliflor'),(12,'berenjena'),(13,'algas'),(14,'sal'),(15,'caviar'),(16,'melón'),(17,'coliflor'),(18,'jamón serrano'),(19,'calabaza'),(20,'anchoa'),(21,'chocolate'),(22,'lima'),(23,'brócoli'),(24,'gamba'),(25,'bacon'),(26,'mejillón'),(27,'plátano'),(28,'morcilla'),(29,'rodaballo'),(30,'lechuga'),(31,'nata'),(32,'ciervo'),(33,'camarón'),(34,'colorante'),(35,'melón'),(36,'perejil'),(37,'soja'),(38,'habas'),(39,'boniato'),(40,'chistorra'),(41,'mango'),(42,'cilantro'),(43,'calabacín'),(44,'lechuga'),(45,'vainilla'),(46,'frambuesa'),(47,'chile'),(48,'sésamo'),(49,'coles'),(50,'yuca'),(51,'membrillo'),(52,'ñame'),(53,'nachos'),(54,'granada'),(55,'avena'),(56,'boquerón'),(57,'pepinillo'),(58,'quinoa'),(59,'higo'),(60,'avellana'),(61,'puerro'),(62,'clavo'),(63,'lubina'),(64,'huevo'),(65,'pimiento'),(66,'spaghetti'),(67,'fideos'),(68,'curry'),(69,'hinojo'),(70,'mafafa'),(71,'coco'),(72,'pollo'),(73,'uva'),(74,'colirrabano'),(75,'espárrago'),(76,'cardo'),(77,'mora'),(78,'endivia'),(79,'fideua'),(80,'macarrón'),(81,'whisky'),(82,'conejo'),(83,'galleta'),(84,'alcachofa'),(85,'mantequilla'),(86,'cardamomo'),(87,'rábano'),(88,'pomelo'),(89,'ketchup'),(90,'bogavante'),(91,'cúrcuma'),(92,'tomillo'),(93,'pepino'),(94,'cigala'),(95,'borraja'),(96,'cayena'),(97,'palta'),(98,'melocotón'),(99,'acelga'),(100,'nabo'),(101,'tomate'),(102,'cebolla'),(103,'zanahoria');
/*!40000 ALTER TABLE `ingredientes` ENABLE KEYS */;
UNLOCK TABLES;

INSERT INTO recetas (id_receta, numeroComensales, instrucciones, nombre_receta) VALUES (1, 1, 'Primero corta las judÌas verdes y se ponen a hervir durante 20 minutos. Ademas, se cuecen los huevos. Se parte la cebolleta, puedes dejarla en agua para que su sabor pierda fuerza. Se lava el tomate, pimiento y lechuga y se trocea. Se mezcla todo el un plato. Cuando estÈn las judÌas y los huevos cocidos se trocean y se aÒaden de la misma manera. Se le aÒade atun', 'Ensalada'),
 (2, 4, 'Primero se cuecen los espaguetis alrededor de unos 9 minutos. Se corta la cebolla en pedacitos pequeÒos y se frÌen durante unos 10 minutos. En un bol, dos huevos. Se echa la nata en con la cebolla y el huevo, se deja durante un par de minutos. Echamos el bacon troceado. Luego lo mezclamos todo con los espaguetis', 'Espaguetis Carbonara'),
 (3, 1, 'Primero se derrite el chocolate en un cazo o en el microondas hasta que quede totalmente lÌquido. Luego se trocea y se rallan las avellanas. Se mezcla todo en un molde o algun recipiente. Se introduce en el congelador durante 2 horas aproximadamente', 'Helado de chocolate y avellanas'),
 (4, 2, 'Primero se debe enjuagar la quinoa y ponerla a hervir durante 15 minutos hasta que el agua haya desaparecido. Se va cortando el pepino, tomate y los pimientos en trozos pequeÒos mientras tanto. Cuando la quinoa estÈ lista, se mezcla todo en un bol aÒadiÈndole atun', 'Ensalada de quinoa y atun'),
 (5, 1, 'Primero se pela una cebolla y se parte, se le quita la piel a la calabaza y se corta de igual manera. En una olla se introduce la cebolla a fuego suave. Cuando esta comience a dorarse, aÒadimos agua y se deja cocer durante 20 minutos. Pasado este tiempo, trituramos todo en la batidora y ya estarÌa lista la crema de calabaza', 'Crema de calabaza');
...
INSERT INTO `ingrediente_receta` VALUES (1,64,1),(2,9,1),(3,101,1),(4,65,1),(5,44,1),(6,3,1),(7,66,2),(8,102,2),(9,64,2),(10,25,2),(11,21,3),(12,60,3),(13,58,4),(14,93,4),(15,101,4),(16,65,4),(17,3,4),(18,19,5),(19,102,5);
...
-- Dump completed on 2020-12-21 23:45:04
